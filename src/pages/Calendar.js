...
function CalendarDay({ day, isWeddingDay, isHoliday }) {
  const dayOfWeekClass = day % 7 === 0 ? 'red' : day % 7 === 6 ? 'blue' : '';
...
function Calendar() {
    ...
    useEffect(() => {
      const updateTimer = () => {
        ...
        const targetDate = new Date('2025-12-07T12:30:00+0900');
  ...
  return (
    <div className='container calendar'>
      ...
      <h3>2025년 12월 7일 일요일 12시 30분</h3>
      ...
      <div className="calendar__body">
        ...
        <div className="calendar__days">
          ...
          {days.map((day) => (
            <CalendarDay key={day} day={day} isWeddingDay={day === 7} isHoliday={day === 25}/>
          ))}
        </div>
      </div>
